        ...
        <View>
            ...
            <Image source={sayembara}/>
                ...
                <View style={styles.card}>
                    ...
                    <View>
                        <TouchableOpacity style={styles.apply} onPress={() => navigation.navigate ('ContentScreen')}>
                            <Text style={{textAlign:'center',fontWeight:"600",paddingTop:10, color:"white",fontSize:16}}>Open</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={styles.card}>
                    ...
                    <Text style={styles.lorem}>Lorem ipsum dolor sit amet, consectetur 
                        adipiscing elit. Praesent nec volutpat massa, ut tempor massa. Maecenas ...</Text>
                    <View>
                        <TouchableOpacity onPress={() => navigation.navigate ('Pemenang')} style={styles.apply5}>
                            <Text style={{textAlign:'center',fontWeight:"600",paddingTop:10, color:"white",fontSize:16}}>Win</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
